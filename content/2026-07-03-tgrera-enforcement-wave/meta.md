...
Data provenance: PUBLIC news-reported regulator orders only — no TERREM DB numbers used.
  Sources verified in signals/2026-07-03.md #3 (NewsMeter, Siasat, Deccan Chronicle).
Target metric: 3s-hold ≥ 30% | completion ≥ 25% | clicks ≥ 30
QA: PASS (specs level) — provenance check ✓ (all figures from cited public orders; no
